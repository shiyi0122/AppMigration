...
//
//    //跳过认证接口方法
//    private static final List<String> AUTH_LIST = Arrays.asList("oneClickLogin", "loginOrVisitor", "thirdLogin", "userRegister","touristsGetToken","getSysGuideAppAgreement","coordinateDistance");
//
//
//    //后台接口
