...
public class FromCityToProvince {
    ...
    public static String findObjectProvinces(String cityName) {
        if (cityName == null) {
            return cityName;
        }
        if (cityName.contains("市")) {
    ...
    public static void main(String[] args) {
        System.out.println(findObjectProvinces("青岛"));
    }
}
